...
import dev.gtxtreme.calculatorcompose.ui.theme.LightGray
import dev.gtxtreme.calculatorcompose.ui.theme.Orange

@Composable
fun Calculator(state: CalculatorState, modifier: Modifier, buttonSpacing: Dp, onAction: (CalculatorAction) -> Unit) {
